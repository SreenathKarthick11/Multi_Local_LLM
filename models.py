...
class ResourceRoute(BaseModel):
    use_web: bool  = Field(description="Whether a search is needed")
    web_query: str = Field(description="The query to use for searching")

    use_rag: bool  = Field(description="Whether retrieval from the vector database is useful.")
    rag_query: str = Field(description="Query to search the vector database.")
